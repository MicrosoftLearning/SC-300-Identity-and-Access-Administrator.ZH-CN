...
5. 请注意，现在可以使用“+ 新建应用程序”。
6. 选择“+ 新建应用程序”
7. 查看“**+ 创建自己的应用程序**”未显示为灰色。如果选取库应用，将看到“**创建**”按钮可用。

   备注：此角色现在能够向租户添加应用程序。我们将在以后的实验室中更多地试用该功能。

8. 退出登录门户中的 Chris Green 实例并关闭浏览器。
...
2. 连接到 Microsoft Entra 管理中心 ([https://admin.microsoft.com](https://admin.microsoft.com))。
