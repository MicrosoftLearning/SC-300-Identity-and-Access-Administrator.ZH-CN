...
ms.locfileid: "138421447"
---
# <a name="lab-12---enable-azure-ad-multi-factor-authentication"></a>实验室 12 - 启用 Azure AD 多重身份验证
...
### <a name="exercise-1---review-and-enable-multifactor-authentication-in-azure"></a>练习 1 - 在 Azure 中查看并启用多重身份验证
...
6. 此时，将出现以下两种情况之一：  收到一条提示你需要设置 Authenticator 应用以及注册 MFA 的消息。  使用你的个人电话按照提示完成注册。  备注 - 你可能会收到一条登录失败的消息，其中包含几个有关如何继续的选项。  在这种情况下，单击“重试”。
