...
# 此实验室仅在非实验室托管环境中正常运行。 如果你想用个人帐户试用，应该可以运行。 无法在类中执行。





**备注** - 此实验室标题为“可选”。  至少需要 1 小时才能完成，并且需要你详细说明实验步骤。  在时间允许的情况下请随时使用计算机。  如果你的公司已经设置了混合配置，或者你不打算使用 Microsoft Entra Connect，请跳过此实验室。
...
#### 任务 1 - 创建本地 Active Directory基础结构
...
### 任务 5 - 配置 contoso.local Active Directory
...
## 练习 2：将 Active Directory 林集成到 Azure Active Directory 租户中

### 任务 1：创建 Azure Active Directory 租户并激活 EMS E5 试用版
...
“基本信息”选项卡：
    -   选择租户类型：选择“Azure Active Directory”
...
7. 创建后，打开“Azure Active Directory”。
...
11. 在“Contoso - 概述”页上，选择“用户” 。

12. 请注意，此新租户中只有一个 ExternalAzureAD 用户。

### 任务 2：创建并配置 Azure AD 用户以管理此目录
...
6. 在“新建用户”页上，确保选中“创建用户”选项，指定以下设置，然后选择“创建”  ：

    - 用户名：**john.doe @your Azure AD 租户域名**，其中 Azure AD 租户域名是创建 Contoso Azure AD 租户时指定的域名。
...
### 任务 5：在 Contoso Active Directory 林中配置 DNS 后缀
...
20. 在“域和 OU 筛选”页面上，选择“同步选定的域和 OU”并确保仅选择 DemoAccounts OU 及其所有子 OU，然后选择“下一步”   。 
...
### 任务 8：配置 Azure AD Connect 属性级筛选条件
